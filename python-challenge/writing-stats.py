...
def main_menu():
  ...
  try:
    if main_menu_choice == 1:
      ...
      print '\nNo idea what that was, try something else.'
      main_menu()
  except:
    ...
    raw_input('Something caused an exception in the main menu. Press any key to exit.')
    sys.exit(1)
...
def writing_stats(content):
  ...
  try:
   ...
   print 'Handled exception - writing stats error:'
   raw_input('That exception is straight up handled. Press any key to exit to the main menu.')
   main_menu()
...
def pasted_text():
  ...
  try:
    ...
    print 'That didn\'t go as planned, exiting to the main menu.'
    main_menu()  
...
def file_text():
  ...
  try:
    ...
    print 'Handled exception - file import:'
    raw_input('\nThe file reading didn\'t go as planned, exiting to the main menu.\n')
    main_menu()
